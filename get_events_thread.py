...
def clear_dismissed_events_that_have_ended(globals):
    globals.dismissed_events.remove_events_based_on_condition(condition_function_for_removing_dismissed_events)
...
def set_events_to_be_displayed(globals):
    ...
    # Need to reset the "system" by clearing all of the dismissed and snoozed events
        globals.dismissed_events.remove_events_based_on_condition(condition_function_to_clear_all_events)
        globals.snoozed_events.remove_events_based_on_condition(condition_function_to_clear_all_events)
